...
no = "130"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [95,125,79,60,100,81];
height = 650;
weight = 235;
male = 50.2;
female = 49.8;
...
type2 = "flying";
scale = 5;
desc1 = "It has an extremely aggressive nature. The Hyper Beam \nit shoots from its mouth totally incinerates all targets.";
desc2 = "Once it begins to rampage, a Gyarados will burn \neverything down, even in a harsh storm.";
var done = false;
