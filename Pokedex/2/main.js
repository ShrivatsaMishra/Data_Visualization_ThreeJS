...
no = "006"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [78,84,78,109,85,100];
height = 170;
weight = 90.5;
female = 11.86;
male = 88.14;
...
scene.background = new THREE.Color(0xFFA000);
...
loader.load( '../three.js-master/examples/fonts/helvetiker_regular.typeface.json', function ( font ) {
    ...
    geometry = new THREE.TextGeometry( 'It spits fire that is hot enough to melt boulders. \nIt may cause forest fires by blowing flames.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    geometry = new THREE.TextGeometry( 'Its wings can carry this Pokémon close to an altitude \nof 4,600 feet. It blows out fire at very high temperatures.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    makeTypeCube(25, 50, x, y-150, z-200);
