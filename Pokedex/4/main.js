...
no = "009"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [60,65,60,130,75,110];
height = 150;
weight = 40.5;
female = 49.98;
male = 50.02;
...
type2 = "poison";
scale = 2;
desc1 = "On the night of a full moon, if shadows move on their own \nand laugh, it must be Gengar's doing.";
desc2 = "It is said to emerge from darkness to steal the lives of \nthose who become lost in mountains.";
...
hlight = new THREE.AmbientLight (0xffffff,0.75);
scene.add(hlight);
...
loader.load( '../three.js-master/examples/fonts/helvetiker_regular.typeface.json', function ( font ) {
    ...
    text = new THREE.Mesh( geometry, material );
    text.position.set(x, y+110, z-305);
    text.rotation.y=Math.PI/2;
    scene.add(text);
    ...
    t = new THREE.TextureLoader().load('../types/ghost.png');
    ...
    t = new THREE.TextureLoader().load('../types/dark.png');
    ...
    t = new THREE.TextureLoader().load('../types/normal.png');
