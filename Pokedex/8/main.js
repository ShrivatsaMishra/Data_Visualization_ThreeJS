...
no = "151"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [100,100,100,100,100,100];
height = 40;
weight = 4;
female = 0;
male = 0;
...
type2 = "blank";
scale = 60;
desc1 = "It's very intelligent and can use an incredible variety of \nmoves. Many believe that all other Pokémon are descendants of this one.";
desc2 = "This mythical Pokémon is said to be extinct, but sightings \nof it are still being reported to this day.";
