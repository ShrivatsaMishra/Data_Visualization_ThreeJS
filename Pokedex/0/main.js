...
scene.background = new THREE.Color(0xfbca3c);
...
var t = new THREE.TextureLoader().load('../types/electric.png');
...
makeTypeCube(30, 60, 120, 110, -160);
...
loader.load( '../three.js-master/examples/fonts/helvetiker_regular.typeface.json', function ( font ) {
    ...
    text = new THREE.Mesh( geometry, material );
    text.position.set(x, y+110, z-267)
    text.rotation.y=Math.PI/2;
    scene.add( text );
    ...
    geometry = new THREE.TextGeometry( 'Pikachu that can generate powerful electricity have \ncheek sacs that are extra soft and super stretchy.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    geometry = new THREE.TextGeometry( 'When Pikachu meet, they\'ll touch their tails together and\nexchange electricity through them as a form of greeting.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    makeTypeCube(25, 50, x, y-60, z-160);
    ...
    makeTypeCube(25, 50, x, y-120, z-150);
    t = new THREE.TextureLoader().load('../types/flying.png');
    makeTypeCube(25, 50, x, y-120, z-210);
    t = new THREE.TextureLoader().load('../types/steel.png');
    makeTypeCube(25, 50, x, y-120, z-270);
