...
no = "143"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [160,110,65,65,110,30];
height = 210;
weight = 460;
female = 11.86;
male = 88.14;
...
type2 = "blank";
scale = 20;
desc1 = "It is not satisfied unless it eats over 880 pounds of food \nevery day. When it is done eating, it goes promptly to sleep.";
desc2 = "This Pokémon's stomach is so strong, even eating moldy or \nrotten food will not affect it.";

var done = false;
scene = new THREE.Scene();
scene.background = new THREE.Color(0x633C25);
