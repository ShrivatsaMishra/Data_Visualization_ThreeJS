...
scene.background = new THREE.Color(0x7f01fe);
...
var t = new THREE.TextureLoader().load('../types/poison.png');
...
t = new THREE.TextureLoader().load('../types/ground.png');
...
loader.load( '../three.js-master/examples/fonts/helvetiker_regular.typeface.json', function ( font ) {
    ...
    text = new THREE.Mesh( geometry, material );
    text.position.set(x, y+110, z-285)
    text.rotation.y=Math.PI/2;
    scene.add( text );
    ...
    // } );
    // text = new THREE.Mesh( geometry, material );
    // text.position.set(x, y+110, z-303);
    // text.rotation.y=Math.PI/2;
    // scene.add(text);

    geometry = new THREE.TextGeometry( 'When it goes on a rampage, it’s impossible to control. \nBut in the presence of a Nidoqueen it’s lived with \nfor a long time, Nidoking calms down.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    geometry = new THREE.TextGeometry( 'Nidoking prides itself on its strength. It’s forceful \nand spirited in battle, making use of its thick tail \nand diamond-crushing horn.', {
        font: font,
        size: 8,
        height: 1,
        curveSegments: 3,
    ...
    t = new THREE.TextureLoader().load('../types/ground.png');
    makeTypeCube(25, 50, x, y-60, z-260);
    t = new THREE.TextureLoader().load('../types/psychic.png');
    makeTypeCube(25, 50, x, y-60, z-320);
    ...
    t = new THREE.TextureLoader().load('../types/fighting.png');
    makeTypeCube(25, 50, x, y-120, z-140);
    t = new THREE.TextureLoader().load('../types/poison.png');
    makeTypeCube(25, 50, x, y-120, z-200);
    t = new THREE.TextureLoader().load('../types/bug.png');
    makeTypeCube(25, 50, x, y-120, z-260);
    t = new THREE.TextureLoader().load('../types/rock.png');
    makeTypeCube(25, 50, x, y-120, z-320);
    t = new THREE.TextureLoader().load('../types/fairy.png');
    makeTypeCube(25, 50, x, y-120, z-380);
    t = new THREE.TextureLoader().load('../types/electric.png');
    makeTypeCube(25, 50, x, y-150, z-140);
