...
no = "150"
stats = [0, 0, 0, 0, 0, 0];
stats_real = [106,110,90,154,90,130];
height = 200;
weight = 122;
female = 0;
male = 0;
...
type2 = "blank";
scale = 0.5;
desc1 = "Created from the DNA of Mew, this Pokémon is a dangerous \ncombination of overwhelming power and a savage heart.";
desc2 = "The research efforts of a certain scientist ultimately \nresulted in this Pokémon. Its powers are dedicated to battling.";

var done = false;
scene = new THREE.Scene();
scene.background = new THREE.Color(0xC19BA6);
...
loader.load( '../three.js-master/examples/fonts/helvetiker_regular.typeface.json', function ( font ) {
    ...
    geometry = new THREE.TextGeometry( "Gender Less", {
        font: font,
        size: 10,
        height: 1,
        curveSegments: 3,
    ...
    text = new THREE.Mesh( geometry, material );
    text.position.set(x, y+120, z-285)
    text.rotation.y=Math.PI/2;
    scene.add( text );
    ...
    cube.position.set(x, y+90, z+270)
